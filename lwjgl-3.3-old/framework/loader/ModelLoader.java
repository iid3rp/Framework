...
public final class ModelLoader
{
    ...
    public static int loadCubeMap(String[] textureFiles)
    {
        ...
        GL11.glTexParameteri(GL13.GL_TEXTURE_CUBE_MAP, GL11.GL_TEXTURE_WRAP_S, GL_CLAMP_TO_EDGE);
        GL11.glTexParameteri(GL13.GL_TEXTURE_CUBE_MAP, GL11.GL_TEXTURE_WRAP_T, GL_CLAMP_TO_EDGE);
        textureList.addAll(textureID);
        return textureID;
