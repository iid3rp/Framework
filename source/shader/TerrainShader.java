...
{
    public static final String VERTEX_FILE = "source/script/terrainVertexShader.glsl";
    public static final String FRAGMENT_FILE = "source/script/terrainFragmentShader.glsl";
