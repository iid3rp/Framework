...
import framework.normals.VertexNormal;
...
public class ObjectLoader
{
    ...
    private static void calculateTangents(VertexNormal v0, VertexNormal v1, VertexNormal v2,
        ...
        Vector3f deltaPos1 = v0.getPosition().sub(v1.getPosition(), v0.getPosition());
        Vector3f deltaPos2 = v0.getPosition().sub(v2.getPosition(), v0.getPosition());
        Vector2f uv0 = textures.get(v0.getTextureIndex());
        Vector2f uv1 = textures.get(v1.getTextureIndex());
        Vector2f uv2 = textures.get(v2.getTextureIndex());
        Vector2f deltaUv1 = uv0.sub(uv1, uv0);
