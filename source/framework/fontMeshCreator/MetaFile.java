...
public class MetaFile {
	...
	protected MetaFile(String file) {
		this.aspectRatio = (double) DisplayManager.getWindowWidth() / (double) DisplayManager.getWindowHeight();
	...
	/**
	 * Gets the array of integers associated with a variable on the current line.
	 * 
	 * @param variable
	 *            - the name of the variable.
	...
	/**
	 * Opens the font stream, ready for reading.
	 * 
	 * @param stream
	 *            - the font stream.
	 */
	private void openFile(InputStream stream) {
		try {
			reader = new BufferedReader(new InputStreamReader(stream));
		} catch (Exception e) {
			System.err.println("Couldn't read font meta stream!");
			System.exit(-1);
		}
	}
