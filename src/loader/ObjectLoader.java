 ...
 * The {@link #calculateTangents(VertexNormal, VertexNormal, VertexNormal, LinkList)}
...
public class ObjectLoader
{
    ...
    private static void processVertex(String[] vertexData, LinkList<Integer> indices, LinkList<Vector2f> textures, LinkList<Vector3f> normals, float[] textureArray, float[] normalsArray) {
    ...
    public static Model loadObject(String objFileName) {
        ...
        String line;
        LinkList<VertexNormal> vertices = new LinkList<>();
        LinkList<Vector2f> textures = new LinkList<>();
        LinkList<Vector3f> normals = new LinkList<>();
        LinkList<Integer> indices = new LinkList<>();
        try {
    ...
    private static void calculateTangents(VertexNormal v0, VertexNormal v1, VertexNormal v2, LinkList<Vector2f> textures) {
    ...
    private static VertexNormal processVertex(String[] vertex, LinkList<VertexNormal> vertices, LinkList<Integer> indices) {
    ...
    private static void convertDataToArrays(LinkList<VertexNormal> vertices, LinkList<Vector2f> textures, LinkList<Vector3f> normals,
