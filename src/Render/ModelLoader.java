...
{
    private final List<Integer> vao = new ArrayList<>();
    ...
    private void storeDataInAttributes(int i, int coordinationSize, float[] f)
    {
    ...
    private FloatBuffer storeDataInFloat(float[] f)
    {
