...
public class Entity {
    ...
    {
        this.texturedModel = new TexturedModel(entity.getTexturedModel().getModel(), entity.getTexturedModel().getTexture());
        ...
        this.mouseListeners = new ArrayList<>(entity.getMouseListeners());
        this.focusListeners = new ArrayList<>(entity.getFocusListeners());
        this.mouseColor = new Color(entity.getMouseColor().getRGB());
        this.highlightColor = new Vector4f(entity.getHighlightColor());
    }
